<div>
    <div class="modal modal-update-room" @if ($show && $modal == 'update') style="display:block" @endif>
    ...
    <div class="modal modal-delete-room" @if ($show && $modal == 'delete') style="display:block" @endif>
                ...
                <section class="modal-card-body">
                    ...
                    @else
                        <div class="field">
                            ...
                            <div class="control">
                                <input class="input name" disabled type="text" value="{{ $room->name }}">
                            </div>
                        </div>
                    @endif
                </section>
