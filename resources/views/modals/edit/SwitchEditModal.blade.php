        ...
        <div style="margin-top: 40px" class="modal-card">
            ...
            <section class="modal-card-body">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input hostname" name="hostname" type="text" value=""
                ...
                <div class="columns">
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="select is-fullwidth is-small">
                                <select class="site_id" name="site_id">
                    ...
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="select is-fullwidth is-small">
                                <select class="building_id" name="building_id">
                ...
                <div class="columns">
                    <div class="column is-6">
                        <div class="field">
                            ...
                            <div class="select is-fullwidth is-small">
                                <select class="room_id" name="room_id">
                    ...
                    <div class="column is-6">
                        <div class="field is-fullwidth">
                            ...
                            <input class="input is-small is-fullwidth location_description" name="location_description" type="number"
                                placeholder="1">
                        </div>
                    </div>
                </div>
