<div class="column is-narrow is-menu">
    <aside class="menu">
        <div style="padding-bottom:40px;">
            <h2 class="is-logo has-text-centered"><i style="font-size:25px;margin-left:-6px" class="fa fa-terminal"></i> <span class="logo-text">cesma</span></h2>
            </h2>
            ...
            <div class="menu-items">
                ...
                <ul class="menu-list">
                    <li>
                        <a href="{{ route('dashboard') }}" class="{{ (request()->is('/')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fa fa-bars-progress"></i></span> <span>{{ __('Menu.Switches') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('backups') }}" class="{{ (request()->is('switch/backups')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fas fa-hard-drive"></i></span> <span>{{ __('Menu.Backups') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('vlans') }}" class="{{ (request()->is('vlans')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fa fa-ethernet"></i></span> <span>{{ __('Menu.Vlans') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('uplinks') }}" class="{{ (request()->is('switch/uplinks')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fa fa-up-down"></i></span> <span>{{ __('Menu.Uplinks') }}</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('clients') }}" class="{{ (request()->is('clients')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fas fa-computer"></i></span> <span>{{ __('Menu.Clients') }}</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="menu-list">
                    <li>
                        <a href="{{ route('user-settings') }}" class="{{ (request()->is('user-settings')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fa fa-user-gear"></i></span> <span>{{ __('Menu.Usersettings') }}</span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="menu-list">
                    ...
                    <li>
                        <a href="{{ route('logs') }}" class="{{ (request()->is('logs')) ? 'has-text-primary' : '' }}">
                            <span class="icon"><i class="fas fa-clock-rotate-left"></i></span> <span>{{ __('Menu.Log') }}</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="{{ route('logout') }}" onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                            <span class="icon"><i class="fas fa-power-off"></i></span> <span>{{ __('Menu.Logout') }}</span>
                        </a>
                ...
                <button class="button is-fullwidth" style="position:absolute;bottom:0;" onclick="collapseMenu(false, this)"><i class="fas fa-angle-left"></i></button>
            </div>
