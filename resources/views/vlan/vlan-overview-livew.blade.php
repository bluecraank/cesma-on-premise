            ...
            <tr>
                ...
                <td style="width:150px;">
                    ...
                    <a class="button is-success is-small" href="/vlans/{{ $vlan->vid }}">
                        ...
                        <button onclick="editVlanModal('{{ $vlan->id }}', '{{ $vlan->name }}', '{{ $vlan->description }}', '{{ $vlan->ip_range }}', '{{ $vlan->scan }}', '{{ $vlan->sync }}')" class="button is-info is-small"><i class="fa fa-gear"></i></button>
