...
<div class="box">
    <h1 class="title is-pulled-left">{{ __('Buildings') }} - {{ Auth::user()->currentSite()->name }}</h1>
    ...
    <div class="is-pulled-right">
        <button title="Export zu CSV" class="button is-small is-primary export-csv-button mr-2" data-table="table"
            data-file-name="{{ __('Buildings') }}"><i class="fa-solid fa-file-arrow-down"></i></button>
    </div>
