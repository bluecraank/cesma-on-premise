    ...
    <div class="is-pulled-right">
        <div class="field">
            <div class="control has-icons-right">
                <input class="input" type="text" wire:model.debounce.500ms="searchTerm" placeholder="Search a locationx">
                ...
                <tr>
                    ...
                    <td style="width:150px;">
                        <div class="has-text-centered">
                            <button onclick='editSwitchModal({{ $location->id }})'
                                class="button is-info is-small"><i class="fa fa-gear"></i></button>
                            <button onclick='deleteSwitchModal({{ $location->id }})'
